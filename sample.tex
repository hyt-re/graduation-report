\documentclass{ujreport}% 標準のクラスファイル
\usepackage[utf8]{inputenc} % 文字コードをUTF-8に指定
\usepackage[T1]{fontenc}    % 欧文フォントをT1に指定
...
%%%%% 論分要旨 %%%%%
\abstract{
表紙に続きあああ，論文要旨 (1ページ) を付けること。論文要旨は，読者が論文全文を読まなくても，その論文に何が書いてあるかがわかるような内容でなければならない。
